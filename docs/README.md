...
| 0g | [`38-phase4-verified-policy.md`](38-phase4-verified-policy.md) | **Phase 4 contract and dependency map: what already exists, the eight real gaps, ownership, order and gates** |
...
| 8b | [`36-integration-protocol.md`](36-integration-protocol.md) | **Shared-file seam register and the continuous-integration rule. Mandatory from Phase 3** |
